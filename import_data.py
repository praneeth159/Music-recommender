...
def create_spectrogram(verbose=0, mode=None):
    if mode == "Train":
        ...
        filename_metadata = "C:/Users/User/Desktop/miniproj3.2/fma_metadata/tracks.csv"
        tracks = pd.read_csv(filename_metadata, header=2, low_memory=False) #header tells which line to start first. To read the entire file as one use low_memory=False
        ...
        folder_sample = "C:/Users/User/Desktop/miniproj3.2/fma_small"
